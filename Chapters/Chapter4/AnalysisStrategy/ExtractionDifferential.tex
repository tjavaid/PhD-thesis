...
rapidity of the four-lepton system ($\pt({\rm H})$ or $\pt(4\ell)$, $|y({\rm H})|$ or $|y(4\ell)|$), which probe the production mechanism,
...
of the decay mechanism. The binning boundaries for each kinematic observable have been optimized in order to have a similar expected measured cross-section for every bin.
...
In order to perform the differential measurements, the background  to be subtracted at the reconstruction level for each bin
...
structure. The mass spectrum also can have non-negligible correlation with the observables. For example, in we consider the observable m${}_{Z2}$, the 
...
Figures~\ref{fig:bkg-rapidity4l-qqZZ-ZX} and~\ref{fig:bkg-rapidity4l-qqZZ-ggZZ}, for $|\cos \theta^{*}|$ in Figures~\ref{fig:bkg-cosThetaStar-qqZZ-ZX}
...
for $N_{\rm jets}$ in Figures~\ref{fig:bkg-njets_reco_pt30_eta4p7-qqZZ-ZX} and~\ref{fig:bkg-njets_reco_pt30_eta4p7-qqZZ-ggZZ}). Similarly, fractions
of background events in each bin of $\pt(4\ell)$, $m(\mathrm{Z}_{2})$, $N_{\rm jets}$, $|y(4\ell)|$  and  $|\cos \theta^{*}|$~are presented in 
Tables~\ref{tab:fractions_pT4l},~\ref{tab:fractions_massZ2},~\ref{tab:fractions_rapidity4l},~\ref{tab:fractions_cosThetaStar} 
...
\par
Examples of the fitted signal line shapes for differential bins of $\pt({\rm H})$ from gg$\rightarrow$H ({\sc powheg+JHUgen} 125 $\GeV$) in the individual
...
\begin{figure}[htb]
  \begin{center}
    ...
    \subfigure[$0.0 < \pt(\mathrm{H}) < 15.0$]{
      \includegraphics[width=0.3\textwidth,angle=0]{Plots/ggH_powheg15_JHUgen_125_4mu_pT4l_genbin0_recobin0_effs_eventMCWeight.pdf}
      \label{fig:sigfits-pT4l-ggH-powheg15-JHUgen-125-maintext:b}
    }
   \subfigure[$0.0 < \pt(\mathrm{H}) < 15.0$]{
      \includegraphics[width=0.3\textwidth,angle=0]{Plots/ggH_powheg15_JHUgen_125_2e2mu_pT4l_genbin0_recobin0_effs_eventMCWeight.pdf}
      \label{fig:sigfits-pT4l-ggH-powheg15-JHUgen-125-maintext:c}
    }  \\
    \subfigure[$15.0 < \pt(\mathrm{H}) < 30.0$]{
      \includegraphics[width=0.3\textwidth,angle=0]{Plots/ggH_powheg15_JHUgen_125_4e_pT4l_genbin1_recobin1_effs_eventMCWeight.pdf}
      \label{fig:sigfits-pT4l-ggH-powheg15-JHUgen-125-maintext:d}
    }
    \subfigure[$15.0 < \pt(\mathrm{H}) < 30.0$]{
      \includegraphics[width=0.3\textwidth,angle=0]{Plots/ggH_powheg15_JHUgen_125_4mu_pT4l_genbin1_recobin1_effs_eventMCWeight.pdf}
      \label{fig:sigfits-pT4l-ggH-powheg15-JHUgen-125-maintext:e}
    }
    \subfigure[$15.0 < \pt(\mathrm{H}) < 30.0$]{
      \includegraphics[width=0.3\textwidth,angle=0]{Plots/ggH_powheg15_JHUgen_125_2e2mu_pT4l_genbin1_recobin1_effs_eventMCWeight.pdf}
      \label{fig:sigfits-pT4l-ggH-powheg15-JHUgen-125-maintext:f}
    } \\
    \subfigure[$30.0 < \pt(\mathrm{H}) < 60.0$]{
      \includegraphics[width=0.3\textwidth,angle=0]{Plots/ggH_powheg15_JHUgen_125_4e_pT4l_genbin2_recobin2_effs_eventMCWeight.pdf}
...
\begin{figure}[htb]
  \begin{center}
    \subfigure[$0.0 \GeV < \pt(\mathrm{H}) < 15.0 \GeV$]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/asimovdata_SM_125_v2_unfoldwith_SM_125_v3_pT4l_4l_recobin0.pdf}
       \label{fig:sigfits-asimov-SM-pT4l-4l:a}
    }
    \subfigure[$15.0 \GeV < \pt(\mathrm{H}) < 30.0 \GeV$]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/asimovdata_SM_125_v2_unfoldwith_SM_125_v3_pT4l_4l_recobin1.pdf}
       \label{fig:sigfits-asimov-SM-pT4l-4l:b}
    } \\
    \subfigure[$30.0 \GeV < \pt(\mathrm{H}) < 60.0 \GeV$]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/asimovdata_SM_125_v2_unfoldwith_SM_125_v3_pT4l_4l_recobin2.pdf}
       \label{fig:sigfits-asimov-SM-pT4l-4l:c}
    }
    \subfigure[$60.0 \GeV < \pt(\mathrm{H}) < 200.0 \GeV$]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/asimovdata_SM_125_v2_unfoldwith_SM_125_v3_pT4l_4l_recobin3.pdf}
