...
The datasets used are listed and documented in ~\ref{HIG-19-001}. 
...
\begin{figure}[!htb]
	...
	\begin{center}
		...
		Trigger efficiency measured in 2018 data using $4\ell$ events collected by single lepton triggers for the $4e$ (top left), $4\mu$ (top right), $2e2\mu$ (bottom left) and $4\ell$ (bottom right) final states. 
			\label{fig:TrigEffC}}
	\end{center}
\end{figure}
%=======
