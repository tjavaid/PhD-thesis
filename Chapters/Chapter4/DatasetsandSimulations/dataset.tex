...
The HLT paths used for full Run 2 collision data is listed in ~\cite{CMS:2019chr} and also in the Appendix. % give address
...
Among the reconstructed four leptons, is geometrically associated with an object that passes at least one single electron or muon triggers.
...
can be formed using the probe leptons, probes are call passing probes which are countedas numerator for the efficiency measurement. The details on the procedure can be seen in Section \ref{tnp_procedure}.
