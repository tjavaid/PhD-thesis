...
performed in the $m_{4\ell}$ range from 105~GeV to 140~GeV, are shown in Figure~\ref{fig:sigfits-data-SM-inclusive} and the extracted 8~TeV cross sections
are shown in Figure~\ref{fig:inclusive-results:b}. While the extracted integrated cross section results for 7~TeV and ratio of 7 and 8~TeV for different
final state within same $m_{4\ell}$ range are shown in Figures~\ref{fig:inclusive-results:a} and \ref{fig:ratio7o8-results-summary}. 
The red error bar represents the systematic uncertainty, while black error bar represents the combined statistical and 
systematic uncertainties, summed in quadrature. The additional systematic uncertainty associated with the model dependence
is separately represented by a grey box. Above listed results are summarized in Tables \ref{tab:incresults} and \ref{tab:incresultsPAS}.
...
The $\Hllll$ measurements are compared to the SM NNLL+NNLO theoretical estimations where the acceptance of the 
dominant $\ggH$ contribution is modelled using {\sc HRes}, {\sc minloHJ} or {\sc powheg+JHUgen},  
VBF contribution is modelled by {\sc powheg}, VH and $\ttH$ contributions are modelled by {\sc pythia}, 
and total rate is rescaled to the SM NNLL+NNLO theoretical result.
...
When extracting the total H$\rightarrow4\ell$ fiducial cross section, the parameter of interest is the total fiducial cross section and
the fractions of $4e,4\mu,$ and $2e2\mu$ is floated in the fit. When extracting the fiducial cross section for each final state, the three
parameters of interest are the cross sections of three individual final states.
...
\begin{figure}[!htb]
  \begin{center}
    ...
    \subfigure[$4\mu$]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/data_unfoldwith_SM_125_v2_mass4l_4mu_recobin0_unpublished.pdf}
       \label{fig:sigfits-data-SM-inclusive:b}
    } \\
    \subfigure[$2e2\mu$]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/data_unfoldwith_SM_125_v2_mass4l_2e2mu_recobin0_unpublished.pdf}
       \label{fig:sigfits-data-SM-inclusive:c}
    }
    \subfigure[$4\ell$]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/data_unfoldwith_SM_125_v2_mass4l_4l_recobin0.pdf}
...
\begin{figure}[!h!tb]
  \begin{center}  
    \subfigure[$\Hllll$ (7 TeV)]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/mass4l_unfoldwith_SM_125_7TeV_unpublished.pdf}
      \label{fig:inclusive-results:a}
    }

    \subfigure[$\Hllll$ (8 TeV)]{
      \includegraphics[width=0.48\textwidth,angle=0]{Plots/mass4l_unfoldwith_SM_125_unpublished.pdf}
      \label{fig:inclusive-results:b}
    }
 
    \caption{Results of the integrated fiducial cross section measurement for different final states. 
    Predictions from {\sc HRes}, {\sc powheg+JHUgen} and {\sc minloHJ} are shown in pink, blue and yellow, respectively.
    In case of the the total integrated cross section measurement ($4\ell$, first bin) the fraction of $4e,4\mu,$ and $2e2\mu$ is floated in the fit.
    } 
...
collisions at 7~TeV and 8~TeV.
        } \label{tab:incresults}
\begin{tabular}{|c|c|}
\hline %---------------------------------------------------------
\hline %---------------------------------------------------------
\multicolumn{2}{|c|}{ \textbf{Fiducial cross section $\Hllll$ at 7~TeV}} \\
\hline %---------------------------------------------------------
\vspace{-0.4cm} & \\
...
\vspace{-0.4cm} & \\
%Measured & $0.94^{\rm +0.79}_{\rm -0.57} \, {\rm(stat.)}\, ^{\rm +0.22}_{\rm -0.18}\,  {\rm (sys.)} \, ^{+0.04}_{-0.03}\,  {\rm (model)}\, {\rm fb}$  \\
\small gg$\rightarrow$H({\sc HRes}) + XH & $0.93^{\rm +0.10}_{\rm -0.11}{\rm fb}$ \\
\vspace{-0.4cm} & \\
...
\hline %---------------------------------------------------------
\vspace{-0.4cm} & \\
\small gg$\rightarrow$H({\sc powheg+JHUgen}) + XH & $0.94^{\rm +0.10}_{\rm -0.10}{\rm fb}$ \\ 
\vspace{-0.4cm} & \\
\hline %---------------------------------------------------------
\vspace{-0.4cm} & \\
...
The measurement of the integrated $\Hllll$ fiducial cross section using 8~TeV data is found to be nice agreement with the theoretical predictions 
within the corresponding uncertainties. The dominant and sub-dominant uncertainty  on the measurement is dominated and sub-dominated 
is statistical and systematic uncertainties which is about 37\% and  12\% respectively. The theoretical uncertainty is about 11\%, close to the
systematic uncertainty. The measurements of integrated $\Hllll$ fiducial cross section at 7~TeV and the ratio of  7~TeV and 
8~TeV are also compared with theoretical estimation based on SM. The measurements are found to be compatible with prediction with
 large statistical uncertainties which varies from 80--100\%.
 
%============
\begin{table}[!h!tb]
\begin{center}
      \caption{ 
The results of the $\Hllll$ integrated fiducial cross section measurement performed in the $m_{4\ell}$ range from 105~GeV to 140~GeV, and
results of the $\Zllll$ integrated fiducial cross section measurement performed in the $m_{4\ell}$ range from 50~GeV to 105~GeV.
        } \label{tab:incresultsPAS}
\begin{tabular}{|c|c|c|c|c|}
\hline %---------------------------------------------------------
\hline %---------------------------------------------------------
\multicolumn{5}{|l|}{ Fiducial cross section H$\rightarrow 4l$ (fb) at 8~TeV. } \\
\hline %---------------------------------------------------------
& 4l & $2e2\mu$ & $4\mu$ & $4e$ \\
\hline %---------------------------------------------------------
\vspace{-0.4cm} &&&&\\
