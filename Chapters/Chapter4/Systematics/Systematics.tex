...
\subsection{Experimental uncertainties sources}
...
Other theoretical uncertainty source is PDF set choice which is determined RMS of the variation when different replicas of default NNPDF set is used.
