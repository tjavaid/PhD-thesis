...
\subsection{Experimental uncertainties souces}
Main experimental uncertainties affecting signal and background are uncertainty on integrated luminosity
(from 2.3\% to 2.6\%, depending on the year of data taking) and the uncertainty on efficiencies of lepton reconstruction and identification (ranging from 2.5\% ($4\mu$)--16.1\% ($4e$)). 
Uncertainties on estimation of reducible backround, %as discussed in %described in Section~\ref{sec:redbkgd},
%described in Section~\ref{sec:background_model},
described in Section \ref{syst_reducible_bkg},
originating from the background composition and misidentification rate uncertainty vary for different final states.
%and category. 
%vary between 6\% to 32\% from the variation of the fake rates. 
Mismatch in composition of backgrounds between different samples where the fake rate is derived and where it is applied accounts between 24\%($4\mu$) and 43\%($4e$).
%($4\mu$)  to 32\% ($4e$).  

Lepton energy scale uncertainty is assessed by propagating down to the four-leptons invariant mass the uncertainty associated the lepton momentum corrections on each indiviudal lepton. 
It is estimated by exploiting $Z\rightarrow\ell\ell$ invariant mass distributions both in data and the simulation. 
Events are categorized on the basis $\pt$ and $\eta$ of either (randomly determined) of two leptons and integrating on the other lepton. The dilepton mass distributions are then fit by parameterization of a Breit-Wigner convoluted with a DCB function.
...
Difference between new mean value and default one gives an estimation of impact of lepton energy scale. 
Values of the differences are reported in the Table~\ref{tab:leptonscalereso}, together with estimation of the impact of lepton momentum resolution, following a similar procedure.
...
\begin{table}[h]
   \centering
    \caption{
    Difference (in \%) between the nominal mean and the width of four-leptons or Higgs invariant mass distribution and those where the lepton momentum scale and resolution uncertainties have been propagated.
    }
...
Estimation of the theoretical uncertainties affecting signal and the background include uncertainties from factorization and renormalization scale is done by varying the two scales 0.5-2 times the nominal values with their ratio kept in between 0.5-2.
...
Additional uncertainty on the background which is 10\% on K factor applied on $ggZZ$ prediction is considered as described in Section~\ref{sec:background_model}.
Systematic uncertainty of about 2\% on the branching ratio of ~$\Hllll$ is only applicable to signal yield. 
...
Additional sources are the imprecise jet energy scale and resolution knowledge (from 2\% to 22\% ), the efficiency on b-tagging and the light quarks ($i.e.$ u, d, s, c) and gluon jet mistag rate. 
While cross section measurement, signal cross section uncertainties arising from theoretical sources are removed. %, while they are kept in the signal strength measurement. 
...
\begin{table}[!htb]
        \begin{center}
                \small
                \caption{
                        Experimental systematic uncertainties in $\Hllll$ measurements of 2016, 2017 and 2018 data. %Details about the derivation of each uncertainty can be found in the text.
      ...
      \hline %---------------------------------------------------------
                        ...
                        \hline %---------------------------------------------------------
                        \hline %---------------------------------------------------------
                        \multicolumn{4}{|c|}{Uncertainties related uncertainties} \\
                        \hline %--------------------------------------------------------
                        %\vspace{-0.4cm} & \\
                        ...
                        \hline %---------------------------------------------------------
                        \hline %---------------------------------------------------------
                        \multicolumn{4}{|c|}{Uncertainties related to signal} \\
                        \hline %---------------------------------------------------------
                        %\vspace{-0.4cm} & \\
...
%		\small
%		\caption{
%			A chart of experimental systematic uncertainties in the $\Hllll$ cross section measurements of 2016 data. %Details about the derivation of each uncertainty can be found in the text.
%			\label{tab:SystOverviewA}
%		}
%		\begin{tabular}{|lc|} 
%			\hline %---------------------------------------------------------
%			\hline %---------------------------------------------------------
%			\multicolumn{2}{|c|}{\textbf{Relative systematic uncertainties}} \\
%			\hline %---------------------------------------------------------
%			\hline %---------------------------------------------------------
%			\multicolumn{2}{|c|}{Uncertainties from common experimental sources } \\
%			\hline %---------------------------------------------------------
%			\vspace{-0.4cm} & \\
%			Luminosity & 2.6 \%  \\ 
%			\vspace{-0.4cm} & \\
...
%			\hline %---------------------------------------------------------
%			\hline %---------------------------------------------------------
%			\multicolumn{2}{|c|}{Uncertainties related to background} \\
%			\hline %--------------------------------------------------------
%			\vspace{-0.4cm} & \\
...
%			\hline %---------------------------------------------------------
%			\hline %---------------------------------------------------------
%			\multicolumn{2}{|c|}{Uncertainties related to Signal} \\
%			\hline %---------------------------------------------------------
%			\vspace{-0.4cm} & \\
...
%\small
%\caption{
%	A chart of experimental systematic uncertainties in the $\Hllll$ cross section measurements of 2017 data
...
%A chart of experimental systematic uncertainties in the $\Hllll$ cross section measurements of 2018 data
...
\caption{Table theory uncertainties in the $\Hllll$ Inclusive cross section measurements}
\begin{tabular}{|lc|}
\hline %---------------------------------------------------------
\hline %---------------------------------------------------------
...
\subsection{Systematic uncertainties treatment when combining yearly measurements on data}
