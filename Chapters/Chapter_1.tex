...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\par 
Meanwhile, QCD part of the SM was also being devolped. There were evidences of the quarks in different scattering experiment facilities in late 60`s. 
...
Later on, discoveries of $\tao$ particle (a $3^{rd}$ generation lepton),  bottom and anti-bottom quarks were discovered in 1976, 1977 and 1995 respectively. Top quark was finally discovered at Fermilab in 1995.
...
Reuslts of scattering experiments e.g. production cross section or a certain process, are compared with prediion of perturbative QCD.
%Experimental results on hard processes are typically compared to predictions of perturbative Quantum Chromodynamics (QCD).
It is possible throug hard scattering experiments to probe at very small scale even shorter than a proton radius. Hence it helps to know the interactions of quarks and gluons (collectively called as partons) processes probe distance scale. A typical diagram of the hard scattering process in proton proton collisions is shown in the Figure. \ref{Fig:scattering} and also in Ref. \cite{scattering}.  %https://arxiv.org/pdf/1202.0583.pdf
\
\begin{figure}
\begin{center}
...
The production cross sections of different process at LHC in the proton-proton collsions are shown in the Figure. \ref{production} in next chapter.\\
...
The quarks and/or gluons when they go through the process of hadronization (bind together to form color siglet) make a bunch of hadrons usually in the form of a cone which are called ``jets'' and are described in Section. \ref{jets}. % provide the link\\
\par In hard scattering  experiments, probablity of a certain process to occur is know as cross section and can be calculated using the Factorization theorem.
This theorem helps to disintegrate the cross section into hard and soft processes using the scale which is know as factorization scale ($\mu_{F}$).\\
