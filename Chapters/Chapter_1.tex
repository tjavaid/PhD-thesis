...
In this chapter, theoretical grounds upon which this dissertation is built, are briefly discussed.  
Under the umbrella of ``elementary particle physics'', we have been able to get answers to long lasting questions about the visible universe and even beyond.  
We have been able to know about the smallest structures of which the uinverse is made and forces which govern them to bind together in the form or ordinary matter.
Standard Model of the particle physics is a theoretical framework capable to explain the dynamics of these subatomic world of particles in its beautiful mathematical formulations which are based on symmetries.
Higgs boson is manifestation of arguments from core components of Standard Model which was first discovered at CERN,LHC facility in proton proton collisions.  
In next Sections, details on Standard Model, its Higgs sector are described. Additionally, underlying theoretical concepts on collision experiment (i.e. proton-proton) are discussed. % 
\section{The Standard Model}\label{chapter1_sec1_SM}
The Standard Model (SM) of particle physics, is the theory which has provided modern concept of understanding the dynamics of the constituents of the matter and underlying principles through which they interact with each other. 
It is capable to give unified explanation of electromagnetic (EM), weak and strong forces (except the gravity) ~\cite{Reference1}. 
\subsection{From the History}
\par SM is a quantum field theory (QFT) belonging to \suthreec$\otimes$\sutwol$\otimes$\uoneg~gauge symmetry group. It was formulated from a collaborative work spanned throughout the 20$^{th}$ century. In 1961, there was a proposal from Glashow that electromagnetic and weak intractions are similar substrctures of electroweak intraction and presented their unified interpretation with \sutwol$\otimes$\uoneg ~symmetry group.  Brout, Englert, Higgs \textit{et al.} proposed a mechanism with which fundamental particles may acquire mass through the idea of spontaneous symmetry breaking and associated new elementary particle called Higgs boson. Salam and Weinberg then annexed this idea to the Glashow's model (\sutwol$\otimes$\uoneg ) and completed the EW sector of SM. %this idea in SM to complete EW . 
\par In 1964, Gell-Mann and Zweig proposed the quark model independently and at the same time Nambu \textit{et al.}, in 1965, gave the idea of color charge an important property of a quark. In 1973, formulation of strong force as a QFT (Quantum Chromodynamics, QCD),  was done with \suthreec~ by Gell-Mann and Fritzsh. Earlier in 1972, Veltnam and Hooft proved SM to be a renormalizable theory making perturbation theory applicable for detailed calculations and resulting predictions be tested in the experiments.
...
interaction~\cite{Referencea}. 
%Weak force is mediated by $W^\pm$ and $Z$ bosons. In terms of a field theory, it is represented by gauge theory with symmetry group $SU(2)$,
...
%bdus Salam, and Steven Weinberg for their role in electroweak unification. In the field theory representation, Electroweak unification is settled under the gauge group
%\sutwol$\otimes$\uoneg~. 
Experimental observation of existence of electroweak interaction was accomplished in two phases, the first was disclosure of existence of neutral current in scattering  of neutrino in 1973 by Gargamelle collaboration and then the discovery of $W$ and Z gauge bosons in proton-antiproton collisions by both the UA1 and the UA2
collaborations in 1983~\cite{Reference2,Reference3,Reference4,Reference5}. After EW was widely accepted, the Physics Nobel Prize was awarded to Sheldon Glashow, Abdus Salam, and Steven Weinberg for their role in electroweak unification.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\par 
Meanwhile, QCD part of the SM was also being developed. There were evidences of the quarks in different scattering experiment facilities in late 60`s. 
In 1974, existence of the quarks was further verified with the discovery of $\jpsi$ meson. Friedman \textit{et al.} and Richter with Ting were nominated for the Nobel prizes for the discoveries of quark and charmonium respectively.
Later on, discoveries of $\tau$ particle (a $3^{rd}$ generation lepton),  bottom and anti-bottom quarks were discovered in 1976, 1977 and 1995 respectively. Top quark was finally discovered at Fermilab in 1995.
All the discoveries in this era, provided a consistent test of SM predictions. Higgs boson, however, still remained unobserved untill July 2012 when CMS and ATLAS collaborations of CERN announced its discovery ~\cite{Reference20,Reference21}. Over this extraordinary experimental success, Higgs and Englert were awarded with Physics Nobel Prize in 2013 for their theoretical predictions about this gauge boson.% of a gauge bosonOne patch of SM was still a missing patch
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%the fundamental 
...
%interactions with the concept of mediating gauge bosons. The last unverified part of the SM, the Higgs boson, was discovered in 2012 at LHC of European Organization for Nuclear Research(CERN)~\cite{Reference20,Reference21}.  
%
Despite of an incredibly successful theory of particle world, the SM does fail to fully describe the known universe.
...
The elementary particles \footnote{Particle having unknown structure is called fundamental particle.} of SM have certain trends and can be listed in terms of a table like a periodic table of elements in Chemistry. Fundamental particles can be categorized into fermions (characterized by Fermi-Dirac statistics) and bosons (Bose-Einstein statistics). 
...
Ordinary matter is composed of $\mathrm{1^{st}}$ generation of fermions, i.e. leptons (e.g. electron that revolves around the nucleus) and quarks (which bind to give protons and neutrons of which nucleus is composed)
which are categorized in three ``generations'' as illustrated in Table \ref{table:quarks_leptons}. 

\par Leptons, in each doublet or generation, there is a lepton and corresponding neutrino ($\nu$) as neutral particle. Leptons only interact via electromagnetic and weak interaction, since they have no color charge. 
%In fact, quarks and gluons are only particles carrying the color charge. 
%Lepton generations each a charged lepton and a neutrino associated. 
Neutrinos are electrically neutral and carry no color charges, so interact through weak force only. 
 ...
 Charged leptons carry $-1$ and their antiparticle carry $+1$ electric charge. In addition, lepton number can be assigned to the particles which is ``1'' for leptons and ``-1'' for anti-leptons. Lepton number is conserved in SM processes.\\


In all generations, quarks carry only fractional charges. First generation includes an ``up'' type quark which carries electric charge $+\frac{2}{3}$ and a ``down'' type quark carrying electric charge
...
\begin{table}[!h!tb]
        \begin{center}
                ...
                %\scriptsize
                \caption{
			%Summary of different Standard Model particles, and values of parameters related to them. Masses of the particles are taken from \cite{masses} ~(In SM neutrino masses are taken as zero.). 
			Summary of different Standard Model particles, and values of parameters related to them. %Masses of the particles are taken from \cite{masses} ~(In SM neutrino masses are taken as zero.). 
                        \label{table:quarks_leptons}
                } % \footnote{In SM neutrino masses are taken as zero.}
                %\begin{tabular}{|l|c|c|c|c|} \hline \hline
                \begin{tabular}{|l|c|c|c|c|c|} \hline \hline
			\textbf{Family (generation)} & Name & Symbol & Mass  & Charge$[e]$ & Interactions \\ \hline \hline
                   %     \multicolumn{6}{|c|}{Individual Higgs boson production modes} \\ \hline
			leptons $(\mathbf{1^{st}})$& electron-neutrino &  $\nu_{e}$ & <2 $eV$  & 0 & weak \\
			leptons $(\mathbf{1^{st}})$& electron &  $e$ & 0.511 $MeV$  & -1 & weak, EM \\
			leptons $(\mathbf{2^{nd}})$& muon-neutrino &  $\nu_{\mu}$ & <0.19 $MeV$  & 0 & weak \\
			leptons $(\mathbf{2^{nd}})$& muon &  $\mu$ & 105.658 $MeV$  & -1 & weak, EM \\
			leptons $(\mathbf{3^{rd}})$& tau-neutrino &  $\nu_{\tau}$ & <18.2 $MeV$  & 0 & weak \\
			leptons $(\mathbf{3^{rd}})$& tau &  $\tau$ & 1776.82 $MeV$  & -1 & weak, EM \\ \hline \hline
			quarks $(\mathbf{1^{st}})$& up &  $u$ & 2.3 $MeV$  & $+\frac{2}{3}$ & EM, weak, strong \\
			quarks $(\mathbf{1^{st}})$& down &  $d$ & 4.8 $MeV$  & $-\frac{1}{3}$ & EM, weak, strong \\
			quarks $(\mathbf{2^{nd}})$& charm &  $c$ & 1.275 $GeV$  & $+\frac{2}{3}$ & EM, weak, strong \\
			quarks $(\mathbf{2^{nd}})$& strange &  $s$ & 95 $MeV$  & $-\frac{1}{3}$ & EM, weak, strong \\
			quarks $(\mathbf{3^{rd}})$& top &  $t$ & 173.07 $GeV$  & $+\frac{2}{3}$ & EM, weak, strong \\
			quarks $(\mathbf{3^{rd}})$& bottom &  $b$ & 4.18 $GeV$  & $-\frac{1}{3}$ & EM, weak, strong \\
...
%\includegraphics[width=0.8\linewidth]{Figures/SM.png}
%\includegraphics[width=1.0\linewidth]{Figures/SM.pdf}
\includegraphics[width=1.0\linewidth]{SM.pdf}
%\includegraphics[width=0.8\linewidth]{Figures/SM.svg}
%\includesvg[width=0.8\linewidth]{Figures/SM}
\end{center}
...
\caption{The elementary particles given in three generations of matter, the gauge bosons and the Higgs boson.}
\label{Fig:Standard_Model_of_Elementary_Particles}
\end{figure}

%Figure diagram: ref http://www.texample.net/tikz/examples/model-physics/
...
encoded in SM. 
%Electromagnetic and weak interactions were then unified into electroweak (EWK) interaction
%%at the unification energy scale of the order of 100~GeV 
%with significant contributions by Abdus Salam, Sheldon Glashow and Steven Weinberg. 
%The mathematical 
%description of interaction of charged particles are described by QED. Photon of QED is the force carrier of electromagnetic force. QED is the first theory which explains the interaction between light and matter that patches up special relativity and quantum mechanics. 
%%Figure \ref{Fig:Feynmann_Diagram_Gluon_Radiation} shows an example of QED, electron-positron annihilation.
%Annihilation is the process of destruction of particle and anti particle pair to any set of particles 
...
\subsubsection{Electroweak unification} \label{ewk_glashow} %  --Glashow–Weinberg–Salam Model}

As discussed above, Glashow proved that EM and weak interactions can be experessed by \sutwol$\otimes$\uoneg~ gauge group, where ``$L$'' represents left handed chiral states of fermionic fields.  ``$Y$'' is the weak hyper charge and can be related to the weak-isospin (T) and electric charge (Q) as follows: \\
\begin{equation}
%W_{\mu}^{\pm} = \sqrt{\frac{1}{2}} (A_{\mu}^{1}\pm iA_{\mu}^{2}) \qquad~M_W = \frac{1}{2}g\mathrm{v}
	W = T_{3} + \frac{Y}{2}%   (A_{\mu}^{1}\pm iA_{\mu}^{2}) \qquad~M_W = \frac{1}{2}g\mathrm{v}
\label{eqn:gmn_formula}
\end{equation}

This is known as Gell-Mann-Nishijima formula and applies to left-handed and right-handed fermions. \\
Left handed states form weak-isospin doublets i.e. $\chi_{L}=(\nu_{\ell}, \ell)^{T}_{L}$, whereas right-handed components from weak-isospin singlet $\psi_{R}=\ell_{R}$.

To establish the local gauge invariance in the proposed theory, three vector fields ($W_{\mu}$) couple to weak isospin currents with strength ``g''. A neutral field denoted by $B_{\mu}$~ couples with strength $\frac{g^{'}}{2}$ to the weak hypercharge. To construct the Lagrangian, the covariant derivative can be written as:\\

\begin{equation}
%W_{\mu}^{\pm} = \sqrt{\frac{1}{2}} (A_{\mu}^{1}\pm iA_{\mu}^{2}) \qquad~M_W = \frac{1}{2}g\mathrm{v}
	%D_{\mu} = \delta_{mu}  + ig\mathbf{T.W_{\mu}} + \frac{ig'}{2} YB_{\mu}%   (A_{\mu}^{1}\pm iA_{\mu}^{2}) \qquad~M_W = \frac{1}{2}g\mathrm{v}
	D_{\mu} = \partial_{\mu}  + ig\mathbf{T.W_{\mu}} + \frac{ig'}{2} YB_{\mu}%   (A_{\mu}^{1}\pm iA_{\mu}^{2}) \qquad~M_W = \frac{1}{2}g\mathrm{v}
\label{eqn:cov_der}
\end{equation}
...
\begin{equation}
	D_{\mu}\chi_{L} \to e^{i \mathbf{\alpha}(x).\mathbf{T}+i \beta (x)Y} D_{\mu}\chi_{L} % 
\label{eqn:act_left}
\end{equation}

\begin{equation}
        D_{\mu}\psi_{R} \to e^{i \mathbf{\beta}(x)Y} D_{\mu}\psi_{R} % 
\label{eqn:act_right}
\end{equation}
...
\begin{equation}
	\mathbf{W_{\mu}} \to \mathbf{W_{\mu}} - \frac{1}{g} \partial_{\mu} ~\mathbf{\alpha} - ~\mathbf{\alpha} \times \mathbf{W_{\mu}} % 
\label{eqn:W_trans}
\end{equation}

\begin{equation}
	B_{\mu} \to B_{\mu} - \frac{1}{g'} \partial_{\mu} \beta. % - ~\mathbf{\alpha} \times \mathbf{W_{\mu}} % 
\label{eqn:B_trans}
\end{equation}
...
\begin{equation}
\begin{aligned}
	\mathscr{L}_{EWK}= \bar{\chi_{L}}(x)i\gamma^{\mu}(\partial_{\mu}  + ig\mathbf{T.W_{\mu}} + \frac{ig'}{2} YB_{\mu}) \chi_{L}(x) + \\
\bar{\psi_{R}}(x)i\gamma^{\mu}(\partial_{\mu}+i\frac{ig'}{2} YB_{\mu})\psi_{R}(x)+  \\
\frac{1}{4} \mathbf{W_{\mu\nu}}\mathbf{W^{\mu\nu}}+\frac{1}{4} B_{\mu\nu}B^{\mu\nu}
\label{eqn:ewk_lagrangian}
\end{aligned}
\end{equation}

Where $\mathbf{W_{\mu\nu}}$ and $B_{\mu\nu}$ are the kinetic energy terms of gauge fields and can be written as in equations. \ref{eqn:wmunu} and \ref{eqn:bmunu} ~ respectively.

\begin{equation}
        \mathbf{W_{\mu\nu}} \equiv \partial_{\mu}\mathbf{W_{\nu}}- \partial_{\mu}\mathbf{W_{\mu}} -g\mathbf{W_{\mu}}\times \mathbf{W_{\nu}}   %  
\label{eqn:wmunu}
\end{equation}
...
$\mathbf{T}$ being the generators of \sutwo which are related to the Pauli matrices as:

\begin{equation}
	T^{a}=\frac{1}{2}\sigma^{a} ; a=1,2,3
%  \begin{array}{c}
%   \phi^{\dag}   \\
%   \phi^{0} 
%  \end{array}
...
%\begin{equation}
%       \mathscr{L}_{EWSB} B_{\mu} \to B_{\mu} - \frac{1}{g'} \partial_{\mu} \beta. % - ~\mathbf{\alpha} \times \mathbf{W_{\mu}} % 
%\label{eqn:ewsb_lagrangian}
%\end{equation}
The Lagrangian in equation \ref{eqn:ewk_lagrangian} describes of electroweak particle (massless lepton). In order to keep the theory invariant under the transformations as described in equtions \ref{eqn:W_trans} and \ref{eqn:B_trans}, mass term has been chosen to be zero i.e. the theory remains unable to describe the kinematics of the massive gauge bosons.\\
Some years later, Salam \textit{et al.}~ introduced a mechanism to include the mass term in the Lagrangian ($\mathscr{L}_{EWK}$ in equation. \ref{eqn:ewk_lagrangian}) keeping the theory anomaly free. More details are described in the next Section.
...
Glashow's proposal of unification of EM and weak forces described the kinematics of massless particle only as described in Section \ref{ewk_glashow}. 
However, gauge fields must acquire mass in order to correctly describe weak interaction and to be consistent with experimental findings. 
...
%boson fundamental fields, which can maintain the local gauge invariance. 
The Higgs mechanism was postulated as a part of SM, which introduces the 
...
\end{equation}
%here $V(\phi^{\dag}\phi)=-(\mu^{2}\phi^{\dag}\phi + \lambda(\phi^{\dag}\phi)^2)$ and is called field's self interaction or potential term , $D_{\mu}$ is described in Equation. \ref{eqn:cov_der}. The lagrangian described in Equation 
here $V$ is called field's self interaction or potential term , $D_{\mu}$ is described in Equation. \ref{eqn:cov_der}. 
The lagrangian described in Equation 
...
in terms of the covariant derivatives whereas the potential only depends upon the product $\phi^{\dag}\phi$. 
$\phi$ is the scalar field and can be codified in terms of quantum numbers which are isospin ($I_3$), hypercharge (Y) and electric charge (Q):
...
% \begin{table}[h!]
 ...
 \end{tabular}
  \end{center} 
%  \end{table}
%Since the ``BEG'' field as described in Equation. \ref{eq:higgs_doublet_field} is a doublet with $Y=1$
...
here $\mu$ is mass term and the parameter $\lambda$ represents the strength of the interaction. As $ \mu^{2} < 0$ and $\lambda>0$ and the 
potential shapes becomes like a ``mexican hat''very interesting, which is essential for Higgs mechanism shown in Figure \ref{Fig:higgs_potential}. 
There occurs a minima for 
\begin{equation}
\phi^{\dag}\phi =  \frac{1}{2}(\phi_{1}^{\dag}+\phi_{2}^{\dag}+\phi_{3}^{\dag}+\phi_{4}^{\dag}) =  \frac{-\mu^{2}}{2\lambda} \equiv \frac{v^{2}}{2}
% \phi^{\dag}\phi =  \frac{-\mu^{2}}{2\lambda} \equiv \frac{\mathrm{V^{2}}}{2}
\end{equation}
...
\includegraphics[width=0.6\linewidth]{Figures/chapter1_Figure/higgs_potential.png}
\end{center}
\caption{The Higgs potential as in Eq.\ref{eq:higgs_potential}}
\label{Fig:higgs_potential}
\end{figure}
Naturally the whole system will be residing in arbitrarily chosen vacuum state; however, this state is away from the symmetry center. So, the minimum does not exist at a single value of $\phi$, but at circular non-zero values.The ($\phi^{\dag}\phi^0$) selection that affiliated with 
...
\right), \qquad v^2=-\frac{\mu^2}{\lambda}.
\end{equation}
...
\begin{equation}
 ...
 \phi = \frac{1}{\sqrt{2}}e^{\frac{i}{v}\phi^{a}t_{a}\phi}=
  \left(
  \begin{array}{c}
   0   \\
   %H+\nu
...
%here $\phi_a$ and $\phi_4 = h(x)+\nu$ represents massless fields called Goldstone fields. New degrees of freedom is introduced
here $\phi_a$ and $\phi_4 = h(x)+v$ represents massless fields called Goldstone fields. New degrees of freedom is introduced
...
%$$\phi^{\prime} =  e^{-\frac{i}{\nu}\phi^{a}\mathbf{T_{a}}}\phi = \frac{1}{\sqrt{2}}
$$\phi^{\prime} =  e^{-\frac{i}{v}\phi^{a}\mathbf{T_{a}}}\phi = \frac{1}{\sqrt{2}}
\left(
  \begin{array}{c}
   0   \\
   %H+\nu
...
The BEH Lagrangian can be written from Equation ~\ref{eq:EWSB_lagrangian} as:

\begin{equation}
\begin{aligned}
\mathscr{L}_{BEH}= \frac{1}{4}g^{2}\nu^{2}W^{+}_{\mu}W^{-\mu}-\frac{1}{2}(\partial_{\mu}W^{+}_{\nu}-\partial_{\nu}W^{+}_{\mu})(\partial^{\mu}W^{-\nu}-\partial^{\nu}W^{-\mu})+ \\
	\frac{1}{8}(g^2+g''^2)v^{2}Z_{\mu}Z^{\mu}-\frac{1}{4}(\partial_{\mu}Z_{\nu}-\partial_{\nu}Z_{\mu})(\partial^{\mu}Z^{\nu}-\partial^{\nu}Z^{\mu})- \\
	\frac{1}{4}F_{\mu\nu}F^{\mu\nu}+\frac{1}{2}\partial_{\mu}h\partial^{\mu}h-\mu^{2}h^{2}+.....
%	%next
%
%	\bar{\chi_{L}}(x)i\gamma^{\mu}(\partial_{\mu}  + ig\mathbf{T.W_{\mu}} + \frac{ig'}{2} YB_{\mu}) \chi_{L}(x) + \\
%\bar{\psi_{R}}(x)i\gamma^{\mu}(\partial_{\mu}+i\frac{ig'}{2} YB_{\mu})\psi_{R}(x)+  \\
%\frac{1}{4} \mathbf{W_{\mu\nu}}\mathbf{W^{\mu\nu}}+\frac{1}{4} B_{\mu\nu}B^{\mu\nu}
\label{eqn:EWSB_lagrangian}
\end{aligned}
...
where $W$ terms are written as:
\begin{equation}
	W^{\pm} =(\left\frac{W^{1}\mp~iW^2}{\sqrt{2}})\right    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
	\label{w_terms}
\end{equation}

These terms correspond to the oppositely charged $W$ bosons whose mass is given by:
\begin{equation}
	m_{W}=\frac{1}{2}vg
	\label{mw}
\end{equation}

There also emerges a term for the neutral vector Z boson:
\begin{equation}
	Z_{\mu} =\frac{-g'B_{\mu}+gW^{3}_{mu}}{\sqrt{g^{2}+g''^{2}}}    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
        \label{zmu_term}
\end{equation}

$Z$ boson mass is given by:
\begin{equation}
        m_{Z}=\frac{1}{2}v\sqrt{g^{2}+g''^{2}}
	\label{mz}
\end{equation}
Using $W^{3}_{\mu}$ and $B_{\mu}$, we can also write their combination orthogonal to $Z_{\mu}$
\begin{equation}
        A_{\mu} =\frac{g'B_{\mu}+gW^{3}_{mu}}{\sqrt{g^{2}+g''^{2}}}    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
        \label{amu_term}
\end{equation}

The Equation \ref{amu_term} corresponds to photon with the condition:
\begin{equation}
        \frac{g'g}{\sqrt{g^{2}+g''^{2}}}=e    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
        \label{condition}
\end{equation}

From equations \ref{mw} and \ref{mz}, we can have,

\begin{equation}
	\frac{m_{W}}{m_{Z}}= \frac{g}{\sqrt{g^{2}+g''^{2}}}    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
        \label{ratio}
\end{equation}
Suppose, the $\theta_{W}$ be weak mixing angle with definition,
\begin{equation}
	g'=g\tan{\theta_{W}}    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
        \label{mixing_angle}
\end{equation}

Using Equation \ref{mixing_angle}, we can write the Equations \ref{zmu_term} and \ref{amu_term} as:
\begin{equation}
	Z_{\mu}= -B_{\mu}\sin{\theta_{W}}+W^{3}_{\mu} \cos{\theta_{W}}    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
        \label{zmu_term1}
\end{equation}

\begin{equation}
        A_{\mu}= B_{\mu}\sin{\theta_{W}}+W^{3}_{\mu} \cos{\theta_{W}}    %\mathscr{L}_{H}+\mathscr{L}_{HW}+\mathscr{L}_{HZ}
        \label{amu_term1}
\end{equation}

With spontaneous symmetry breaking (SSB), gauge bosons (W,Z) acquire masses as a result of interaction with BEH (or Higgs) field. 
Also, after SSB, BEH (or Higgs) fields emerges with a physical boson particle. Lagrangian (potential term) can be written as:
\begin{equation}
	\mathscr{L}_{V}= \frac{1}{4}\lambda(v+h(x))^{4}-\frac{1}{2}\lambda v^{2}(v+h(x))^{2}  
	\label{lag_pot}
\end{equation}
This gives the Higgs mass at first order; $M_{H}^2=2\lambda v^2$ \\
The value of $v$ (also $g$) can be measured using Fermi weak constant i.e. $G_{F}$. However, $\lambda$ is a free parameter in SM.

\par Fermions can also acquire masses if additional gauge invariant interaction term is added to term EW Lagrangian. In this way, fermions can acquire masses when they interact with BEH (or Higgs) field through Yukawa couplings. Interaction term in the Lagrangian can be written as:
\begin{equation}
	\mathscr{L}_{Yukawa}= -G_{l}[\bar{\psi_{R}}(\phi^{\dag}\chi_{L})+(\bar{\chi_{L}}\phi)\psi_{R}]                       % \frac{1}{4}\lambda(v+h(x))^{4}-\frac{1}{2}\lambda v^{2}(v+h(x))^{2}
        \label{yukawa}
\end{equation}

Using $\phi$ and other inputs can further gives us the masses ($m_{f}$) of fermions and couplings ($g_{Hf}$):
\begin{equation}
	m_{f}= \frac{G_{l}}{\sqrt{2}}v       %
        \label{fermion_mass}
\end{equation}

\begin{equation}
	g_{Hf}= \sqrt{G_{l}}\sqrt{2}=\frac{m_{f}}{v}       %
        \label{fermion_coupling}
\end{equation}
...
\section{Phenomenology of proton-proton collisions at LHC} \label{phenomenology}
LHC is the largest colliding experiment of its kind ever built also motivated to perform test of the SM of particle physics.
More details on LHC experiment will be discussed in next chapter.

In this section, however, some phenomenological part of proton-proton collision in high energy experiments, like LHC, are briefly discussed.
Reuslts of scattering experiments e.g. production cross section of a certain process, are compared with prediction of perturbative QCD.
%Experimental results on hard processes are typically compared to predictions of perturbative Quantum Chromodynamics (QCD).
It is possible through hard scattering experiments to probe at very small scale even shorter than a proton radius. Hence it helps to know the interactions of quarks and gluons (collectively called as partons) processes probe distance scale. A typical diagram of the hard scattering process in proton proton collisions is shown in the Figure. \ref{Fig:scattering} and also in Ref. \cite{scattering_pp}.  %https://arxiv.org/pdf/1202.0583.pdf
\
\begin{figure}
\begin{center}
\includegraphics[width=0.7\linewidth]{Figures/chapter1_Figure/scattering.png}
\end{center}
\caption{A schematic diagram of proton-proton collision at high energy experiments }
\label{Fig:scattering}
\end{figure}
Protons are composite particles made up of three valence quarks (uud) which are bound together with strong force exchanging the gluons. 
%When two protons (moving at very high momentum in opposite directions) collide, 
There are several ways through which they can interact within a proton. Quarks can mutually iteract with other quarks or throught annihilation process they can produce gluons which can further go for pair-production of quark anti-quark pair. As a results, apart from the valence quarks, there is a sea of virtual quarks and gluons in side a proton (collectively called partons).
In a collision experiment, it may happen that there is large momentum transfer from the colliding partons. This is called hard scattering and as a results many resonances can be produces e.g. Higgs. Probability of a certain process to occur is known as cross section of that process. 
The production cross sections of different process at LHC in the proton-proton collsions are shown in the Figure. \ref{Fig:lhc_all} in next chapter.\\
Partons which do not take part in hard interaction, usually go straight and may involve in certain low momentum transfer processes. These activities of low momentum transfer are call uncerlying events. In case if more than one interactions happen in a certain proton proton collision, it is referred as multi-parton interactions (MPI).\\
In an accelerated environment, charged partons may radiate photons or gluons through a process known as ``Bremsstrahlung''. If this radiation is associate with the incoming partons, it is called initial state radion (ISR) and if is coming from outgoing parton from the interaction point, it is called final state radiation (FSR).
The quarks and/or gluons when they go through the process of hadronization (bind together to form color siglet) make a bunch of hadrons usually in the form of a cone which are called ``jets'' and are described in Section. \ref{sec:jets}. % provide the link\\
\par In hard scattering  experiments, probablity of a certain process to occur is known as cross section and can be calculated using the Factorization theorem.
This theorem helps to disintegrate the cross section into hard and soft processes using the scale which is known as factorization scale ($\mu_{F}$).\\
Suppose in collision of two protons, A and B, the partons $a$ and $b$ undergo hard scattering which produce a certain final state S. The total cross section can be given by the relation:

\begin{equation}
	\sigma_{AB}=\int dx_{a} dx_{b}f_{a/A}(x_{a},\mu^{2}_{F}) f_{b/B}(x_{b},\mu^{2}_{F}) \hat{\sigma}_{ab~\to~S}           %\frac{G_{l}}{\sqrt{2}}v       %
        \label{prod_XS}
\end{equation}

In above equation, $x_{a}$ is the fraction of momentum of the parton $a $ which it takes from proton A. Similary, 
$x_{b}$ is the fraction of momentum of the parton $b $ which it takes from proton B.
$\mu_{F}$ is factorization scale and is usually of the order of $Q$ which is total momentum transfer of hard process.
$f_{a/A}(x_{a},\mu_{F})$  and~ $f_{b/B}(x_{b},\mu_{F}) $  are the parton distribution functions (PDFs).
...
\section{Higgs boson Production at LHC}\label{chapter1_sec4}
Higgs can be produced at LHC in various production modes. 
The production modes of Higgs which are dominant in proton proton collisions at LHC are illustrated in Figure~\ref{Fig:higgs_production},
corresponding production cross sections as a function of its mass at center-of-mass energies as shown in
Figure~\ref{Fig:Higgs_boson production_crossSection_at_LHC} . A considerable increase in production cross section of Higgs is found as we move towards higher center-of-mass energies  ~\cite{Referenceb}.
\begin{figure}
\begin{center}
%\includegraphics[width=0.7\linewidth]{Figures/chapter1_Figure/HiggsProduction.jpg}
\includegraphics[width=0.65\linewidth]{Figures/chapter1_Figure/higgs_production.png}
\end{center}
\caption{Feynman diagrams of Higgs production at tree level. }
...
\includegraphics[width=0.44\linewidth]{Figures/chapter1_Figure/Escan_h125.pdf}
	 \includegraphics[width=0.54\linewidth]{Figures/chapter1_Figure/plot_13tev_BSM_aa.pdf}
\end{center}
	\caption{Production cross sections of Higgs at 13 TeV as a function of center of mass energies (left) and as a function of its mass (right).}
...
%\label{Fig:higgs_production_sqrt}
%\end{figure}
...
Figure~\ref{Fig:higgs_production}~(top left)~\cite{Referenceb}. 
%As LHC and tevatron are hadron colliders, it highly probable that two gluons responsible for binding of hadron collide. 
The gluons couples to Higgs through the loop of virtual 
quarks, as coupling is directly proportional to fermion mass, top quark loop is most dominant. 
%For SMHiggs ($m_H = 125$~GeV) the ggH cross section at 7~TeV, 8~TeV and 13~TeV are approximately 15, 19, 44~pb respectively. As we move towards higher
...
Figure~\ref{Fig:higgs_production}~(upper right). Its cross section is roughly 10~times lower than ggH at
$m_H = 125$~GeV, and becomes comparable at $m_H = 1$~TeV. 
%For SM Higgs at $m_H = 125$~GeV %center-of-mass energies 
...
%computed at NNLL QCD and NLO EW precision~\cite{Referenceb}. 
In VBF production mode, two $W^\pm$ or $Z$ boson fusion create 
...
two high energy jets in detector in its forward region. These jets signature helps to increase signal to background ratio. 
...
%Figure~\ref{Fig:higgs_production}~(bottom left). 
In W/Z association production mode, 
Higgs is radiated by high energetic $W^\pm$ or $Z$ bosons that is produced by fusion of two fermions. 
%This production mode was leading mechanism at LEP and sub-leading mechanism at Tevatron. At LEP it becomes very probable to produce $W^\pm$ or $Z$ boson with electron positron collisions. In case
%of hadron collider,  tevatron makes quark antiquark collisions more likely as compared to LHC. 
The least dominant process of Higgs production is illustrated in Figure~\ref{Fig:higgs_production}~(bottom right). In this process two gluons
collide producing pair of top antitop which produces Higgs by fusion in association $t\bar{t}$. 
%The ttH cross section for Standard Model Higgs  at center 
...
Higgs, being an electroweak particle, can decay in variety of channels depending upon mass of final state particles, interaction strength and etc. 
%Most of the factors are controlled by SM except the Higgs boson mass itself.
...
The life time of SM 126 GeV Higgs is $1.6\times10^{-22}$~s and it can decay to all SM particles having masses (most probably to heaviest onshell particle). 
Higgs boson decay branching ratio to a variety of particles are illustrated in Figure~\ref{Fig:Higgs_BR}~\cite{Referenceb}. $H\rightarrow b\bar{b}$ (at $m_H \approx 125$~GeV) is the most dominant decay mode of Higgs. But the QCD background in this channel is of
...
As the Higgs mass at 125~GeV, Higgs boson decay to diboson($WW, ZZ$) boson are also available, where one or both boson can be off-shell. $WW$ decay further has neutrinos in final state due to which it is not possible to reconstruct the final state fully.
%, its 
...
%to be low, which makes $WW$ decay channel less sensitive. 
$H \rightarrow ZZ \rightarrow \ell\ell\ell\ell$ decay is labeled as golden channel in 
...
leptons which can reconstructed with excellence in the detector ~\cite{Referenceb}. Measurements on Higgs reported in this dissertation are based on $H \rightarrow ZZ \rightarrow \ell\ell\ell\ell$ channel.
%The branching ratio of the Higgs in intermediate range is illustrated in 
...
\end{center}
	 \caption{Higgs branching ratios for different channels (in terms of mass)}
\label{Fig:Higgs_BR}
\end{figure}
...
%\centerline{\includegraphics [width=\linewidth] {Figures/chapter1_Figure/XSBR_7TeV_SM_LM.pdf}}
%\end{minipage}
%\begin{minipage}{0.5\linewidth}
%\centerline{\includegraphics [width=\linewidth] {Figures/chapter1_Figure/XSBR_8TeV_SM_LM.pdf}}
%\end{minipage}
