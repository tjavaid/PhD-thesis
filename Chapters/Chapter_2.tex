...
\chapter{Experiment: The Large Hadron Collider (LHC) } % Main chapter title
...
during the years 2016, 2017 and 2018 as shown in the Figure \ref{fig:luminosity_2015}, \ref{fig:luminosity_2016}, \ref{fig:luminosity_2017} and \ref{fig:luminosity_2018} respectively. In the figures we can also see the recorded data by the CMS experiment from LHC delivered data in different run periods.
%\vspace{6em}
%
%%%%%%
\begin{figure}[!htb]
...
Besides, the individual experiments of LHC, i.e. CMS, ATLAS, ALICE and LHCb, have also planned certain upgarades during this LS2 period \ref{LS2_upgrades}.\\ % https://indico.cern.ch/event/315626/contributions/729447/attachments/605638/833479/Challenges_Experiments.pdf
