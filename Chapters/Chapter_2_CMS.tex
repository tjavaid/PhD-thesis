...
In order to cope with higher event rate for Run 2 operations, a new trigger architecture, the Time Multiplexed Trigger (TMT) was planted. TMT uses sophisticated algorithms (i.e. FPGAs) in $\mu TCA$ to exploit full granularity of the calorimeters and benefitted from technological improvements in hardware. 
