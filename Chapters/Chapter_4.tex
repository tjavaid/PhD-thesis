...
requirements. They also include triggers requiring three leptons above a low $p_T$ threshold.  It also includes cross-triggers which were added to
...
%
  \small
  \caption{  MC simulation datasets used for the signal processes predicted
  by the SM for m(H)=125.0$\GeV$ (${\rm Z}$ stands for ${\rm Z}$, ${\rm Z}^*$, $\gamma^*$). The cross sections
