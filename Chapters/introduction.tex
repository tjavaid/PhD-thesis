...
These measurements provide a direct test of perturbative QCD  calculations in the Higgs sector of SM at the TeV energy scale. Any deviation of the integrated or the differential cross sections from SM expectations would  provide a direct hint to BSM contributions. 
These measurements with earlier or partial Run2 CMS data has also been performed  and reported in Ref. ~\cite{Khachatryan:2015yvw, CMS:2015hja, CMS:2016rqf, Sirunyan:2017exp, CMS:2018hhg}. Nearly similar measurements have already been reported by ATLAS experiment in $H \rightarrow \gamma \gamma$ ~\cite{atlas-conf-2019-029, ATLAS:Hgg_8TeV,ATLAS:Hgg_8TeV_13TeV} and $H \rightarrow 4\ell$ ~\cite{atlas-conf-2019-025 , ATLAS:H4l_8TeV,ATLAS:H4l_8TeV_13TeV} decay 
...
\begin{itemize}
	...
	\item \textbf{Chapter 2~\ref{Chapter2}: } Overview of relevant experiment i.e. the LHC and its CMS experiment are presented. 
	\item \textbf{Chapter 3~\ref{Chapter3}: } The calibrations and reconstructions of the  physics objects within the CMS detector are described. % in Chapter ~\ref{Chapter3}. 
        \item \textbf{Chapter 4~\ref{Chapter4}: } Presents the procedure of measurements of inclusive and differential fiducial cross sections of H boson production at $\sqrt{s} = 13$~TeV.
	\item \textbf{Chapter 5~\ref{Chapter7}: } Finally, the conclusions and outlook of the dissertation are summarized.
\end{itemize}
