void njets_pt30_eta2p5_unfoldwith_SMdn_125_logscale_asimov()
{
//=========Macro generated from canvas: c/njets_pt30_eta2p5
//=========  (Tue Feb  5 12:05:50 2019) by ROOT version6.02/05
   TCanvas *c = new TCanvas("c", "njets_pt30_eta2p5",0,0,1400,1400);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(-1.153846,-5.950239,5.25641,3.187561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   dummy1->SetMinimum(0.001770072);
   dummy1->SetMaximum(353.1137);
   dummy1->SetEntries(5);
   ...
   Graph_Graph3005->SetMinimum(9.538568e-08);
   Graph_Graph3005->SetMaximum(2.38139);
   ...
   Graph_Graph3006->SetMinimum(0.0265069);
   Graph_Graph3006->SetMaximum(2.214743);
   ...
   Graph_Graph3007->SetMinimum(0.0265069);
   Graph_Graph3007->SetMaximum(1.93918);
...
tex->SetNDC();
   ...
   dummy5->SetMinimum(0.001770072);
   dummy5->SetMaximum(353.1137);
   dummy5->SetEntries(5);
...
// ------------>Primitives in pad: pad
   ...
   pad->Draw();
   pad->cd();
   pad->Range(-1.153846,-1.609661,5.25641,10.77235);
   pad->SetFillColor(0);
   ...
   Graph_Graph3012->SetMaximum(2.724043);
   ...
   Graph_Graph3013->SetMinimum(0.6662299);
   Graph_Graph3013->SetMaximum(1.146435);
   ...
   Graph_Graph3014->SetMinimum(0.7549534);
   Graph_Graph3014->SetMaximum(0.9883911);
