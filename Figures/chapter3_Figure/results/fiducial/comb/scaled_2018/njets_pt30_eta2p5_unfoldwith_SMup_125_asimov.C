void njets_pt30_eta2p5_unfoldwith_SMup_125_asimov()
{
//=========Macro generated from canvas: c/njets_pt30_eta2p5
//=========  (Tue Feb  5 12:05:40 2019) by ROOT version6.02/05
   TCanvas *c = new TCanvas("c", "njets_pt30_eta2p5",0,0,1400,1400);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(-1.153846,-1.959447,5.25641,3.639259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
