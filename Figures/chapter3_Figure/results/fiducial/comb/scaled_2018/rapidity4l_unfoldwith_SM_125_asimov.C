void rapidity4l_unfoldwith_SM_125_asimov()
{
//=========Macro generated from canvas: c/rapidity4l
//=========  (Thu Feb  7 16:46:07 2019) by ROOT version6.02/05
   TCanvas *c = new TCanvas("c", "rapidity4l",0,0,1400,1400);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(-0.5769231,-2.52114,2.628205,4.682404);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   TH1F *Graph_Graph3001 = new TH1F("Graph_Graph3001","",100,0,2.424375);
   ...
   TH1F *Graph_Graph3002 = new TH1F("Graph_Graph3002","",100,0,2.424375);
   ...
   TH1F *Graph_Graph3003 = new TH1F("Graph_Graph3003","",100,0,1.991875);
   ...
   TH1F *Graph_Graph3004 = new TH1F("Graph_Graph3004","",100,0,1.991875);
...
// ------------>Primitives in pad: pad
   ...
   TH1F *Graph_Graph3008 = new TH1F("Graph_Graph3008","",100,0,1.991875);
   ...
   TH1F *Graph_Graph3009 = new TH1F("Graph_Graph3009","",100,0,1.991875);
   ...
   TH1F *Graph_Graph3010 = new TH1F("Graph_Graph3010","",100,0,2.424375);
   ...
   TH1F *Graph_Graph3011 = new TH1F("Graph_Graph3011","",100,0,2.424375);
