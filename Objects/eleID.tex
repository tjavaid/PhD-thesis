...
%\end{verbatim}
%}
Figure ~\ref{fig:ele_ID_output} shows the output of the multiclassifier discriminant for prompt electrons from DY events and fakes from jets in DY events.
...
The impact of the transition from the TMVA(v1) to the xgboost(v2) training library is shown in Figure ~\ref{fig:ele_ID_ROC}.
