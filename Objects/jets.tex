...
A typical diagram of the a jet can be seen in the Figure. \ref{fig:jet_cone} and in Ref. \cite{jets} % http://cms.web.cern.ch/news/jets-cms-and-determination-their-energy-scale
...
A typical diagram of a heavy-flavour jet with a SV from the decay of b or c hadron resulting in charged-particle tracks is shown in the Figure. \ref{fig:bjet} and in Ref. \cite{bjet}.
