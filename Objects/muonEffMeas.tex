...
\paragraph*{Tracking}
The efficiency to reconstruct a muon track in the inner detector is almost 100\% and hence muon Physics Object Group no more recommends tracking scale factors to be applied to the MC in the measurement. % measured using as probes tracks 
