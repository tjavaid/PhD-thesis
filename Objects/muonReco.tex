...
above 200\GeV are considered identified muons if they pass the PF ID or the Tracker
...
It may happen that a single muon is reconstruted incorrectly as two muons or even more. To cope with this situation, additional ``ghost-cleaning'' is performed as:

\begin{itemize}

\item Those tracker Muons which are not Global Muons, are needed to be arbitrated.
\item If two muons are sharing their segments upto 50\% or more, lower quality muon is removed.
